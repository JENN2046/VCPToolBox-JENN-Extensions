...
`VCP_ADMIN_EXTENSION_DIRS` and `VCP_AI_IMAGE_ADAPTER_DIRS` are documented for future reviewed local gates only. They must remain unset during package creation and checksum validation.
